package id.ac.unsyiah.elektro.mobile.kalkulator1;
...
public class MainActivity extends AppCompatActivity {
    ...
    public void onClickTombolHasil(View view) {
        ...
        RadioButton tambah =(RadioButton) findViewById(R.id.operatorTambah);
        RadioButton kurang =(RadioButton) findViewById(R.id.operatorKurang);
        RadioButton kali =(RadioButton) findViewById(R.id.operatorKali);
        RadioButton bagi =(RadioButton) findViewById(R.id.operatorBagi);
